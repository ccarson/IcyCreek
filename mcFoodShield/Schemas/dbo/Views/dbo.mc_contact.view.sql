...
/****** Object:  View [dbo].[mc_contact]    Script Date: 02/18/2013 14:06:21 ******/
...
************************************************************************************************************************************
       ...
       View:  dbo.mc_contact
     Author:  Chris Carson
    Purpose:  portal view of coreSHIELD dbo.Contacts data
...
AS SELECT
    ...
    , c.bVerified, COALESCE( t3.contactsID, 0 ) AS iVerifiedBy, c.dVerifiedDate
    , c.inetwork, c.isSuspect
