        ...
        <html>
            ...
            <body topmargin="0" leftmargin="0" rightmargin="0" onclick="outliner();">
                ...
                <p>
                  <span class="note">
                    <b>
                      <a _locID="ConversionHelpLink" href="http://msdn.microsoft.com/query/dev10.query?appId=Dev10IDEF1&amp;l=EN-US&amp;k=k(SQL.DATA.TOOLS.PROJECTCONVERSION.DIALOG)&amp;rd=true">Learn more about converting to SQL Server Database projects.</a>
                    </b>
                  </span>
                </p>
