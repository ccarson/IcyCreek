CREATE PROCEDURE Utility.MergeContactAddresses ( @MasterContactID   AS UNIQUEIDENTIFIER
...
************************************************************************************************************************************
  ...
  Procedure:    Utility.MergeContactAddresses
     Author:    Chris Carson
    Purpose:    Merges records on dbo.ContactAddresses for two coreShield Contacts
...
BEGIN TRY
    ...
    DECLARE @transactionStarted AS BIT
          , @tableName          AS NVARCHAR (20) = 'mc_contact_addresses' ;
